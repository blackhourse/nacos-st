package cn.boot.mybatisplus.config.springmvc;

import cn.boot.mybatisplus.interceptor.AccessLogInterceptor;
...
public class CommonWebAutoConfiguration implements WebMvcConfigurer {
    ...
    @Bean
    @ConditionalOnClass(name = {"cn.boot.mybatisplus.systemlog.SystemLogService", "javax.annotation.Resource"})
